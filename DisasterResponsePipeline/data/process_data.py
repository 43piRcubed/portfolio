...
def load_data(messages_filepath, categories_filepath):
    # Read in the messages dataset
    messages = pd.read_csv(messages_filepath, dtype=str)
    
    # Read in the categories dataset
...
def clean_data(df):
    '''
    1. breaking categories column into individual catoegories columns and merge back with df dataframe
    2. removing duplicate rows based on message column
    '''
    
    # 1 preparing dataset
    
    # breaking categories column of dataset into individual category columns
